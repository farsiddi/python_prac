...
print(data_dict)  # Coverts into dictionary where each column is itself is a dictionary and all the columns(dictionaries) are nested inside another dictionary
